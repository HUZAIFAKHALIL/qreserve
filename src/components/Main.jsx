...
// import { useState, useEffect } from "react";
// import { toast } from "react-toastify";
// import { Calendar, DollarSign, MapPin, User2, Briefcase, InboxIcon, CheckCircle, Clock, MessageSquare } from "lucide-react";
// import { format, parseISO } from "date-fns";
// import AdminChatMonitoring from "./AdminChatMonitoring"; // Import the new component
...
//     approved: []
//   });
//   const [activeTab, setActiveTab] = useState('services'); // For admin tabs
...
const MainPage = () => {
  ...
  useEffect(() => {
    if (!isLoggedIn || !userID || !userType) {
      return; // Prevents API calls if not logged in
    }
